...
ASGNP4
line 1931
;1931:		CG_ImpactMark( mark, origin, dir, random()*360, color[0],color[1], color[2],1, alphaFade, radius, qfalse );
ADDRLP4 96
ADDRGP4 rand
CALLI4
ASGNI4
...
LABELV $1166
line 1933
;1933:		CG_ImpactMark( mark, origin, dir, random()*360, 1,1,1,1, alphaFade, radius, qfalse );
ADDRLP4 92
ADDRGP4 rand
CALLI4
ASGNI4
...
;1938:/*
;1939:=================
;1940:CG_MissileHitPlayer
;1941:=================
;1942:*/
;1943:void CG_MissileHitPlayer( int weapon, vec3_t origin, vec3_t dir, int entityNum ) {
line 1944
;1944:	CG_Bleed( origin, entityNum );
ADDRFP4 4
INDIRP4
ARGP4
ADDRFP4 12
...
line 1948
;1945:
;1946:	// some weapons will make an explosion with the blood, while
;1947:	// others will just make the blood
;1948:	switch ( weapon ) {
ADDRLP4 0
ADDRFP4 0
INDIRI4
...
LABELV $1173
line 1956
;1949:	case WP_GRENADE_LAUNCHER:
;1950:	case WP_ROCKET_LAUNCHER:
;1951:#ifdef MISSIONPACK
;1952:	case WP_NAILGUN:
;1953:	case WP_CHAINGUN:
;1954:	case WP_PROX_LAUNCHER:
;1955:#endif
;1956:		CG_MissileHitWall( weapon, 0, origin, dir, IMPACTSOUND_FLESH );
ADDRFP4 0
INDIRI4
ARGI4
CNSTI4 0
...
;1973:/*
;1974:================
;1975:CG_ShotgunPellet
;1976:================
;1977:*/
;1978:static void CG_ShotgunPellet( vec3_t start, vec3_t end, int skipNum ) {
line 1982
;1979:	trace_t		tr;
;1980:	int sourceContentType, destContentType;
;1981:
;1982:	CG_Trace( &tr, start, NULL, NULL, end, skipNum, MASK_SHOT );
ADDRLP4 0
ARGP4
ADDRFP4 0
INDIRP4
...
line 1984
;1983:
;1984:	sourceContentType = trap_CM_PointContents( start, 0 );
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 0
...
ASGNI4
line 1985
;1985:	destContentType = trap_CM_PointContents( tr.endpos, 0 );
ADDRLP4 0+12
ARGP4
CNSTI4 0
ARGI4
...
line 1988
;1986:
;1987:	// FIXME: should probably move this cruft into CG_BubbleTrail
;1988:	if ( sourceContentType == destContentType ) {
ADDRLP4 56
INDIRI4
ADDRLP4 60
INDIRI4
NEI4 $1176
line 1989
;1989:		if ( sourceContentType & CONTENTS_WATER ) {
ADDRLP4 56
INDIRI4
CNSTI4 32
BANDI4
...
EQI4 $1177
line 1990
;1990:			CG_BubbleTrail( start, tr.endpos, 32 );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 0+12
...
;1991:		}
line 1992
;1992:	} else if ( sourceContentType & CONTENTS_WATER ) {
ADDRGP4 $1177
JUMPV
LABELV $1176
ADDRLP4 56
...
;1993:		trace_t trace;
;1994:
;1995:		trap_CM_BoxTrace( &trace, end, start, NULL, NULL, 0, CONTENTS_WATER );
ADDRLP4 76
ARGP4
ADDRFP4 4
INDIRP4
...
pop
line 1996
;1996:		CG_BubbleTrail( start, trace.endpos, 32 );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 76+12
...
pop
line 1997
;1997:	} else if ( destContentType & CONTENTS_WATER ) {
ADDRGP4 $1182
JUMPV
LABELV $1181
ADDRLP4 60
...
;1998:		trace_t trace;
;1999:
;2000:		trap_CM_BoxTrace( &trace, start, end, NULL, NULL, 0, CONTENTS_WATER );
ADDRLP4 76
ARGP4
ADDRFP4 0
INDIRP4
...
pop
line 2001
;2001:		CG_BubbleTrail( tr.endpos, trace.endpos, 32 );
ADDRLP4 0+12
ARGP4
ADDRLP4 76+12
ARGP4
...
line 2004
;2003:
;2004:	if (  tr.surfaceFlags & SURF_NOIMPACT ) {
ADDRLP4 0+44
INDIRI4
CNSTI4 16
BANDI4
...
;2006:	}
;2007:
;2008:	if ( cg_entities[tr.entityNum].currentState.eType == ET_PLAYER ) {
CNSTI4 728
ADDRLP4 0+52
INDIRI4
MULI4
...
NEI4 $1191
line 2009
;2009:		CG_MissileHitPlayer( WP_SHOTGUN, tr.endpos, tr.plane.normal, tr.entityNum );
CNSTI4 3
ARGI4
ADDRLP4 0+12
ARGP4
...
LABELV $1191
line 2011
;2011:		if ( tr.surfaceFlags & SURF_NOIMPACT ) {
ADDRLP4 0+44
INDIRI4
CNSTI4 16
BANDI4
...
EQI4 $1198
line 2013
;2012:			// SURF_NOIMPACT will not make a flame puff or a mark
;2013:			return;
ADDRGP4 $1174
JUMPV
LABELV $1198
line 2015
;2014:		}
;2015:		if ( tr.surfaceFlags & SURF_METALSTEPS ) {
ADDRLP4 0+44
INDIRI4
CNSTI4 4096
BANDI4
...
EQI4 $1201
line 2016
;2016:			CG_MissileHitWall( WP_SHOTGUN, 0, tr.endpos, tr.plane.normal, IMPACTSOUND_METAL );
CNSTI4 3
ARGI4
CNSTI4 0
ARGI4
...
LABELV $1201
line 2018
;2018:			CG_MissileHitWall( WP_SHOTGUN, 0, tr.endpos, tr.plane.normal, IMPACTSOUND_DEFAULT );
CNSTI4 3
ARGI4
ADDRLP4 76
CNSTI4 0
...
;2023:/*
;2024:================
;2025:CG_ShotgunPattern
;2026:
;2027:Perform the same traces the server did to locate the
;2028:hit splashes
;2029:================
;2030:*/
;2031:static void CG_ShotgunPattern( vec3_t origin, vec3_t origin2, int seed, int otherEntNum ) {
line 2039
;2032:	int			i;
;2033:	float		r, u;
;2034:	vec3_t		end;
;2035:	vec3_t		forward, right, up;
;2036:
;2037:	// derive the right and up vectors from the forward vector, because
;2038:	// the client won't have any other information
;2039:	VectorNormalize2( origin2, forward );
ADDRFP4 4
INDIRP4
ARGP4
ADDRLP4 20
...
pop
line 2040
;2040:	PerpendicularVector( right, forward );
ADDRLP4 32
ARGP4
ADDRLP4 20
ARGP4
...
pop
line 2041
;2041:	CrossProduct( forward, right, up );
ADDRLP4 20
ARGP4
ADDRLP4 32
ARGP4
...
line 2044
;2042:
;2043:	// generate the "random" spread pattern
;2044:	for ( i = 0 ; i < DEFAULT_SHOTGUN_COUNT ; i++ ) {
ADDRLP4 56
CNSTI4 0
ASGNI4
LABELV $1209
line 2045
;2045:		r = Q_crandom( &seed ) * DEFAULT_SHOTGUN_SPREAD * 16;
ADDRFP4 8
ARGP4
ADDRLP4 60
ADDRGP4 Q_crandom
...
ASGNF4
line 2046
;2046:		u = Q_crandom( &seed ) * DEFAULT_SHOTGUN_SPREAD * 16;
ADDRFP4 8
ARGP4
ADDRLP4 64
ADDRGP4 Q_crandom
...
ASGNF4
line 2047
;2047:		VectorMA( origin, 8192 * 16, forward, end);
ADDRLP4 68
ADDRFP4 0
INDIRP4
ASGNP4
...
line 2051
;2050:
;2051:		CG_ShotgunPellet( origin, end, otherEntNum );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 0
...
;2058:==============
;2059:*/
;2060:void CG_ShotgunFire( entityState_t *es ) {
line 2064
;2061:	vec3_t	v;
;2062:	int		contents;
;2063:
;2064:	VectorSubtract( es->origin2, es->pos.trBase, v );
ADDRLP4 16
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 2067
;2067:	VectorAdd( es->pos.trBase, v, v );
ADDRLP4 28
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 2068
;2068:	if ( cgs.glconfig.hardwareType != GLHW_RAGEPRO ) {
ADDRGP4 cgs+20100+11288
INDIRI4
CNSTI4 3
EQI4 $1240
line 2072
;2069:		// ragepro can't alpha fade, so don't even bother with smoke
;2070:		vec3_t			up;
;2071:
;2072:		contents = trap_CM_PointContents( es->pos.trBase, 0 );
ADDRFP4 0
INDIRP4
CNSTI4 24
ADDP4
...
ASGNI4
line 2073
;2073:		if ( !( contents & CONTENTS_WATER ) ) {
ADDRLP4 12
INDIRI4
CNSTI4 32
BANDI4
...
ASGNF4
line 2075
;2075:			CG_SmokePuff( v, up, 32, 1, 1, 1, 0.33f, 900, cg.time, 0, LEF_PUFF_DONT_SCALE, cgs.media.shotgunSmokePuffShader );
ADDRLP4 0
ARGP4
ADDRLP4 32
ARGP4
...
LABELV $1240
line 2078
;2078:	CG_ShotgunPattern( es->pos.trBase, es->origin2, es->eventParm, es->otherEntityNum );
ADDRLP4 32
ADDRFP4 0
INDIRP4
ASGNP4
...
;2093:===============
;2094:*/
;2095:void CG_Tracer( vec3_t source, vec3_t dest ) {
line 2104
;2096:	vec3_t		forward, right;
;2097:	polyVert_t	verts[4];
;2098:	vec3_t		line;
;2099:	float		len, begin, end;
;2100:	vec3_t		start, finish;
;2101:	vec3_t		midpoint;
;2102:
;2103:	// tracer
;2104:	VectorSubtract( dest, source, forward );
ADDRLP4 180
ADDRFP4 4
INDIRP4
ASGNP4
...
ASGNF4
line 2105
;2105:	len = VectorNormalize( forward );
ADDRLP4 108
ARGP4
ADDRLP4 196
ADDRGP4 VectorNormalize
...
line 2108
;2106:
;2107:	// start at least a little ways from the muzzle
;2108:	if ( len < 100 ) {
ADDRLP4 164
INDIRF4
CNSTF4 1120403456
...
ASGNF4
line 2112
;2112:	end = begin + cg_tracerLength.value;
ADDRLP4 156
ADDRLP4 160
INDIRF4
...
LABELV $1257
line 2116
;2116:	VectorMA( source, begin, forward, start );
ADDRLP4 204
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 2117
;2117:	VectorMA( source, end, forward, finish );
ADDRLP4 212
ADDRFP4 0
INDIRP4
ASGNP4
...
line 2119
;2118:
;2119:	line[0] = DotProduct( forward, cg.refdef.viewaxis[1] );
ADDRLP4 144
ADDRLP4 108
INDIRF4
ADDRGP4 cg+109044+36+12
...
ASGNF4
line 2120
;2120:	line[1] = DotProduct( forward, cg.refdef.viewaxis[2] );
ADDRLP4 144+4
ADDRLP4 108
INDIRF4
ADDRGP4 cg+109044+36+24
...
line 2122
;2121:
;2122:	VectorScale( cg.refdef.viewaxis[1], line[1], right );
ADDRLP4 96
ADDRGP4 cg+109044+36+12
INDIRF4
ADDRLP4 144+4
...
ASGNF4
line 2123
;2123:	VectorMA( right, -line[0], cg.refdef.viewaxis[2], right );
ADDRLP4 220
ADDRLP4 144
INDIRF4
NEGF4
...
line 2126
;2125:
;2126:	VectorMA( finish, cg_tracerWidth.value, right, verts[0].xyz );
ADDRLP4 0
ADDRLP4 132
INDIRF4
ADDRLP4 96
...
ASGNF4
line 2129
;2129:	verts[0].modulate[0] = 255;
ADDRLP4 0+20
CNSTU1 255
ASGNU1
line 2130
;2130:	verts[0].modulate[1] = 255;
ADDRLP4 0+20+1
CNSTU1 255
ASGNU1
line 2131
;2131:	verts[0].modulate[2] = 255;
ADDRLP4 0+20+2
CNSTU1 255
ASGNU1
line 2132
;2132:	verts[0].modulate[3] = 255;
ADDRLP4 0+20+3
CNSTU1 255
ASGNU1
line 2134
;2133:
;2134:	VectorMA( finish, -cg_tracerWidth.value, right, verts[1].xyz );
ADDRLP4 0+24
ADDRLP4 132
INDIRF4
ADDRLP4 96
...
ASGNF4
line 2137
;2137:	verts[1].modulate[0] = 255;
ADDRLP4 0+24+20
CNSTU1 255
ASGNU1
line 2138
;2138:	verts[1].modulate[1] = 255;
ADDRLP4 0+24+20+1
CNSTU1 255
ASGNU1
line 2139
;2139:	verts[1].modulate[2] = 255;
ADDRLP4 0+24+20+2
CNSTU1 255
ASGNU1
line 2140
;2140:	verts[1].modulate[3] = 255;
ADDRLP4 0+24+20+3
CNSTU1 255
ASGNU1
line 2142
;2141:
;2142:	VectorMA( start, -cg_tracerWidth.value, right, verts[2].xyz );
ADDRLP4 0+48
ADDRLP4 120
INDIRF4
ADDRLP4 96
...
ASGNF4
line 2145
;2145:	verts[2].modulate[0] = 255;
ADDRLP4 0+48+20
CNSTU1 255
ASGNU1
line 2146
;2146:	verts[2].modulate[1] = 255;
ADDRLP4 0+48+20+1
CNSTU1 255
ASGNU1
line 2147
;2147:	verts[2].modulate[2] = 255;
ADDRLP4 0+48+20+2
CNSTU1 255
ASGNU1
line 2148
;2148:	verts[2].modulate[3] = 255;
ADDRLP4 0+48+20+3
CNSTU1 255
ASGNU1
line 2150
;2149:
;2150:	VectorMA( start, cg_tracerWidth.value, right, verts[3].xyz );
ADDRLP4 0+72
ADDRLP4 120
INDIRF4
ADDRLP4 96
...
ASGNF4
line 2153
;2153:	verts[3].modulate[0] = 255;
ADDRLP4 0+72+20
CNSTU1 255
ASGNU1
line 2154
;2154:	verts[3].modulate[1] = 255;
ADDRLP4 0+72+20+1
CNSTU1 255
ASGNU1
line 2155
;2155:	verts[3].modulate[2] = 255;
ADDRLP4 0+72+20+2
CNSTU1 255
ASGNU1
line 2156
;2156:	verts[3].modulate[3] = 255;
ADDRLP4 0+72+20+3
CNSTU1 255
ASGNU1
line 2158
;2157:
;2158:	trap_R_AddPolyToScene( cgs.media.tracerShader, 4, verts );
...
line 2160
;2159:
;2160:	midpoint[0] = ( start[0] + finish[0] ) * 0.5;
ADDRLP4 168
CNSTF4 1056964608
ADDRLP4 120
INDIRF4
...
ASGNF4
line 2161
;2161:	midpoint[1] = ( start[1] + finish[1] ) * 0.5;
ADDRLP4 168+4
CNSTF4 1056964608
ADDRLP4 120+4
INDIRF4
...
ASGNF4
line 2162
;2162:	midpoint[2] = ( start[2] + finish[2] ) * 0.5;
ADDRLP4 168+8
CNSTF4 1056964608
ADDRLP4 120+8
INDIRF4
...
line 2165
;2163:
;2164:	// add the tracer sound
;2165:	trap_S_StartSound( midpoint, ENTITYNUM_WORLD, CHAN_AUTO, cgs.media.tracerSound );
ADDRLP4 168
ARGP4
CNSTI4 1022
ARGI4
...
;2170:/*
;2171:======================
;2172:CG_CalcMuzzlePoint
;2173:======================
;2174:*/
;2175:static qboolean	CG_CalcMuzzlePoint( int entityNum, vec3_t muzzle ) {
line 2180
;2176:	vec3_t		forward;
;2177:	centity_t	*cent;
;2178:	int			anim;
;2179:
;2180:	if ( entityNum == cg.snap->ps.clientNum ) {
ADDRFP4 0
INDIRI4
ADDRGP4 cg+36
INDIRP4
...
NEI4 $1439
line 2181
;2181:		VectorCopy( cg.snap->ps.origin, muzzle );
ADDRFP4 4
INDIRP4
ADDRGP4 cg+36
INDIRP4
...
ASGNB 12
line 2182
;2182:		muzzle[2] += cg.snap->ps.viewheight;
ADDRLP4 20
ADDRFP4 4
INDIRP4
CNSTI4 8
...
ASGNF4
line 2183
;2183:		AngleVectors( cg.snap->ps.viewangles, forward, NULL, NULL );
ADDRGP4 cg+36
INDIRP4
CNSTI4 196
ADDP4
...
pop
line 2184
;2184:		VectorMA( muzzle, 14, forward, muzzle );
ADDRLP4 28
ADDRFP4 4
INDIRP4
ASGNP4
...
;2186:	}
;2187:
;2188:	cent = &cg_entities[entityNum];
ADDRLP4 12
CNSTI4 728
ADDRFP4 0
INDIRI4
...
;2191:	}
;2192:
;2193:	VectorCopy( cent->currentState.pos.trBase, muzzle );
ADDRFP4 4
INDIRP4
ADDRLP4 12
INDIRP4
...
line 2195
;2194:
;2195:	AngleVectors( cent->currentState.apos.trBase, forward, NULL, NULL );
ADDRLP4 12
INDIRP4
CNSTI4 60
ADDP4
...
pop
line 2196
;2196:	anim = cent->currentState.legsAnim & ~ANIM_TOGGLEBIT;
ADDRLP4 16
ADDRLP4 12
INDIRP4
CNSTI4 196
...
ASGNI4
line 2197
;2197:	if ( anim == LEGS_WALKCR || anim == LEGS_IDLECR ) {
ADDRLP4 16
INDIRI4
CNSTI4 13
EQI4 $1451
...
LABELV $1451
line 2198
;2198:		muzzle[2] += CROUCH_VIEWHEIGHT;
ADDRLP4 28
ADDRFP4 4
INDIRP4
CNSTI4 8
...
LABELV $1449
line 2200
;2200:		muzzle[2] += DEFAULT_VIEWHEIGHT;
ADDRLP4 28
ADDRFP4 4
INDIRP4
CNSTI4 8
...
line 2203
;2202:
;2203:	VectorMA( muzzle, 14, forward, muzzle );
ADDRLP4 28
ADDRFP4 4
INDIRP4
ASGNP4
...
;2211:CG_Bullet
;2212:
;2213:Renders bullet effects.
;2214:======================
;2215:*/
;2216:void CG_Bullet( vec3_t end, int sourceEntityNum, vec3_t normal, qboolean flesh, int fleshEntityNum ) {
line 2223
;2217:	trace_t trace;
;2218:	int sourceContentType, destContentType;
;2219:	vec3_t		start;
;2220:
;2221:	// if the shooter is currently valid, calc a source point and possibly
;2222:	// do trail effects
;2223:	if ( sourceEntityNum >= 0 && cg_tracerChance.value > 0 ) {
ADDRFP4 4
INDIRI4
CNSTI4 0
LTI4 $1455
...
LEF4 $1455
line 2224
;2224:		if ( CG_CalcMuzzlePoint( sourceEntityNum, start ) ) {
ADDRFP4 4
INDIRI4
ARGI4
ADDRLP4 0
...
ASGNI4
line 2226
;2226:			destContentType = trap_CM_PointContents( end, 0 );
ADDRFP4 0
INDIRP4
ARGP4
CNSTI4 0
...
line 2229
;2227:
;2228:			// do a complete bubble trail if necessary
;2229:			if ( ( sourceContentType == destContentType ) && ( sourceContentType & CONTENTS_WATER ) ) {
ADDRLP4 88
ADDRLP4 12
INDIRI4
ASGNI4
...
EQI4 $1460
line 2230
;2230:				CG_BubbleTrail( start, end, 32 );
ADDRLP4 0
ARGP4
ADDRFP4 0
INDIRP4
...
LABELV $1460
line 2233
;2232:			// bubble trail from water into air
...
EQI4 $1462
line 2234
;2234:				trap_CM_BoxTrace( &trace, end, start, NULL, NULL, 0, CONTENTS_WATER );
ADDRLP4 20
ARGP4
ADDRFP4 0
INDIRP4
...
pop
line 2235
;2235:				CG_BubbleTrail( start, trace.endpos, 32 );
ADDRLP4 0
ARGP4
ADDRLP4 20+12
ARGP4
...
LABELV $1462
line 2238
;2237:			// bubble trail from air into water
;2238:			else if ( ( destContentType & CONTENTS_WATER ) ) {
ADDRLP4 16
INDIRI4
CNSTI4 32
BANDI4
...
EQI4 $1465
line 2239
;2239:				trap_CM_BoxTrace( &trace, start, end, NULL, NULL, 0, CONTENTS_WATER );
ADDRLP4 20
ARGP4
ADDRLP4 0
ARGP4
...
pop
line 2240
;2240:				CG_BubbleTrail( trace.endpos, end, 32 );
ADDRLP4 20+12
ARGP4
ADDRFP4 0
INDIRP4
...
;2242:
;2243:			// draw a tracer
;2244:			if ( random() < cg_tracerChance.value ) {
ADDRLP4 92
ADDRGP4 rand
CALLI4
ASGNI4
...
EQI4 $1471
line 2252
;2252:		CG_Bleed( end, fleshEntityNum );
ADDRFP4 0
INDIRP4
ARGP4
ADDRFP4 16
...
LABELV $1471
line 2254
;2254:		CG_MissileHitWall( WP_MACHINEGUN, 0, end, normal, IMPACTSOUND_DEFAULT );
CNSTI4 2
ARGI4
ADDRLP4 76
CNSTI4 0
